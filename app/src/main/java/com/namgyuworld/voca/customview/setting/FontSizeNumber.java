 ...
 */
public class FontSizeNumber extends HorizontalScrollView{
    ...
    public FontSizeNumber(Context context) {
        super(context);
        initialize(context);
    }

    public FontSizeNumber(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public FontSizeNumber(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public FontSizeNumber(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initialize(Context ctx){
        ...
        int savedFontSize = mPref.getVocaFontSize();
...
//        scrollTo(fontDefaultIndex * (savedFontSize - 10), 0);
        ...
        final int currentFontSizeIndex = mPref.getVocaFontSize() - 10;
